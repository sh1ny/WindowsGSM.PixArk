...
namespace WindowsGSM.Plugins
{
    public class PixArk : SteamCMDAgent
    {
        ...
        {
            name = "WindowsGSM.PixArk", // WindowsGSM.XXXX
            author = "sh1ny",
        ...
        public string StartPath = @"ShooterGame\Binaries\Win64\PixARKServer.exe"; // Game server start path
        public string FullName = "PixArk Dedicated Server"; // Game server FullName
        ...
        public string Defaultmap = "CubeWorld_Light"; // Default map name
